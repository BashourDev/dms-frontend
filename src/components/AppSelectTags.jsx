...
export default function AppSelectTags({
  name,
  label,
  options,
  className,
  ...
  return (
    ...
    >
      <label>{label}</label>
      <Listbox value={"اختر وسم"} onChange={(value) => handleChange(value)}>
        <div className="relative mt-1 h-10">
          <Listbox.Button className="relative w-full py-2 pr-6 pl-10 text-right bg-inherit border-[1px] border-lightGray rounded-lg shadow-md cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-sky-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500 sm:text-sm">
            <span className="block truncate text-right h-5">
              {"اختر وسم للملف"}
            </span>
